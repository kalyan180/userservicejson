...
public class UserController {
	...
	@GetMapping("/jsonData")
	public String getJsonData(@RequestBody JsonExample json){
		return userService.jsonData(json);
	}
	...
	@GetMapping("/apiuser/{userId}")
	public List<Object> getApiInfoFromUser(@PathVariable Integer userId){
		UserEntity id= userService.getUserById(userId);
		ArrayList<Object> list= new ArrayList<Object>();
		Integer realmId=id.getRealId();
		Api response=restTemplate.getForObject("http://localhost:8081/api/"+realmId, Api.class);
