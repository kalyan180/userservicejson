...
public class UserServiceImpl implements UserService{
	...
	@Override
	public String jsonData(JsonExample jsonExample) {
		  Map obj=new HashMap();    
		  obj.put("id", jsonExample.getId());    
		  obj.put("firstName", jsonExample.getFirstName());    
		  obj.put("lastName", jsonExample.getLastName()); 
		  obj.put("roleName", jsonExample.getRoleName());
		  obj.put("gradeLevel", jsonExample.getGradeLevel());
		  obj.put("termId", jsonExample.getTermId());
		  obj.put("sisId", jsonExample.getSisId());
		  obj.put("username",jsonExample.getUsername());
